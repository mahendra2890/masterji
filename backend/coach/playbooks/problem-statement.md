# Playbook: The Problem Statement
*(inspired by Ash Maurya's Lean Canvas and the Jobs-to-be-Done framework — Masterji's own distillation)*

## Why this is the only work that counts in IDEA
You don't have a business idea yet — you have a hunch. A problem statement
turns the hunch into something you can be proven wrong about. Skip it and
every hour spent on branding, features or tech stacks is a guess stacked on
a guess.

## The anatomy of a real problem statement
One paragraph, four things in it:
1. **Who, specifically.** Not "students" — "final-year hostel students who
   order food after 10pm when the mess is closed." A segment you can find
   in one WhatsApp group beats a demographic you'd need a survey to reach.
2. **The trigger.** What moment makes the problem show up? Frequency
   matters — a problem that bites daily is worth more than one that bites
   once a year, however dramatic.
3. **What they do today.** Nobody has a problem with no current answer —
   they have a bad one: calling five shops, going hungry, asking a friend.
   Name the workaround. It's your real competition, not other startups.
